...
<div class = "wrapper">
    ...
    <section class="h1">Продукция <?php echo $title; ?></section>
    <ul class="products">
        <?php foreach ($prods as $prod) { ?>
            <li>
                <a href="/product/view_item/<?php echo $prod->title; ?>/<?php echo $prod->id; ?>">
                    <div class="products_img">
                        <img src="/images/content/preview/<?php echo Phalcon\Text::lower($prod->title); ?>.png" alt="">
                    </div>
