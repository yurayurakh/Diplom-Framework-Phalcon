...
<body>
        ...
        <div class="row">
            <div class="col-sm-3">
                ...
                <ul class="nav nav-stacked">
                    ...
                    <?php if ($role === '1') { ?>
                    <hr>
                    <li><a href="/admin/root/categor/">Категории товаров</a></li>
                    <hr>

                    <li><a href="/admin/root/product/">Товары</a></li>
                    <hr>

                    <li><a href="/admin/root/order/">Заказы</a></li>
                    <hr>

                    <li><a href="/admin/root/user/">Пользователи</a></li>
                    <hr>
                    <li><a href="/admin/root/mail/">Рассылка</a></li>
    ...
    <div>
        <a class="btn btn-success" href="/admin/root/categor/add">
    ...
    <table class="table table-striped table-bordered bootstrap-datatable datatable responsive dataTable" id="DataTables_Table_0" aria-describedby="DataTables_Table_0_info">
        ...
        <?php foreach ($categors as $categ) { ?>
            <tr class="odd">
                ...
                <td class="center ">
                    <a class="btn btn-info" href="/admin/root/categor/edit/<?php echo $categ->id; ?>">
                        <i class="glyphicon glyphicon-edit icon-white"></i>
                    </a>
                    <a class="btn btn-danger" href="/admin/root/categor/delete/<?php echo $categ->id; ?>">
