...
<div class = "wrapper">
    ...
    <br>
    <section class="h1"><?php echo $prod_item->title; ?></section>
    <div class="products_img">
         <div>
        <img src="/images/content/preview/<?php echo Phalcon\Text::lower($prod_item->title); ?>.png" alt="" >
        </div>
        <p><?php echo $prod_item->description; ?></p>

        <ul style="clear: both; margin-top: 20px;">
            <li><b>Ціна</b>: - <?php echo $prod_item->price; ?> гривень</li>
            <li><b>Марка</b>: - <?php echo $prod_item->mark; ?></li>
            <li><b>Категорія</b>: <?php echo $title; ?></li>
            

                <?php if ($prod_item->count > 1) { ?>
                <form action="/basket/prod/<?php echo $prod_item->title; ?>/<?php echo $prod_item->id; ?>" method="post">
