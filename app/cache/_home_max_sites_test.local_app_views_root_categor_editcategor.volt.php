...
<body>
    ...
    <form action="/root/categor/edit" method="post">
        <input type="hidden" name="id" value="<?php echo $cg->id; ?>">
        <div class="form-group">
            <label for="name">Название категории</label>
            <input type="text" class="form-control" name="name" id="name" placeholder="Название категории" value="<?php echo $cg->title; ?>">
        </div>
