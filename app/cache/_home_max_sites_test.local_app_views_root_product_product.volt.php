...
<body>
    ...
    <table class="table table-striped table-bordered bootstrap-datatable datatable responsive dataTable" id="DataTables_Table_0" aria-describedby="DataTables_Table_0_info">
        ...
        <?php foreach ($prodcts as $prodct) { ?>
            <tr class="odd">
                <td class=" sorting_1"><?php echo $prodct->title; ?></td>
                <td class=" sorting_1"><?php echo $prodct->mark; ?></td>
                <td class=" sorting_1"><?php echo $prodct->price; ?></td>
                <td class=" sorting_1"><?php echo $prodct->count; ?></td>
                <td class="center ">
                    <a class="btn btn-info" href="/root/product/edit/<?php echo $prodct->id; ?>">
                        <i class="glyphicon glyphicon-edit icon-white"></i>
                    </a>
                    <a class="btn btn-danger" href="/root/product/delete/<?php echo $prodct->id; ?>">
