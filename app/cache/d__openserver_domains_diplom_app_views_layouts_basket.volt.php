...
<head>
    ...
    <title>Корзина | e-commerce</title>
...
<div class = "wrapper">
    ...
    <section class="h1 title"><?php echo $prod_item->title; ?></section>
    <div class="products_img">
        <div>
            <img class="prod" src="/images/content/preview/<?php echo Phalcon\Text::lower($title); ?>.png" alt="" >
        </div>
        <ul style="clear: both; margin-top: 20px;">
            <li><b>Ціна</b>: - <?php echo $prod_item->price * $count; ?> гривень</li>
            <li><b>Кількість</b>: - <?php echo $count; ?> штук</li>
        </ul>
    </div>
    ...
    <section class="feedback baskets">
        ...
        <form action="/Contact/send" method="post">
            ...
            <input type="hidden" name="allsum"  value="<?php echo $prod_item->price * $count; ?>">
            ...
            <div class="feedback_submit_block">
                <a href="" class="feedback_submit_btn" onclick="alert('Дані відправлено успішно!Ваше замовлення <?php echo $prod_item->title; ?> оброляється! З Вами звяжеться консультант для перевірки інформації. Дякуєм що ви з нами)')">Відправити</a>
                <input type="submit">
            </div>
        </form>
    </section>
